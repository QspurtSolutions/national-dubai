...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a class="btn btn-light" href="{{ route('admin.featured_products.create')}}">Add Featured Product</a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <table class="table table-bordered sub-category-datatable">
            <thead>
                <tr>
                    <th>No</th>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.sub-category-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.featured_products.list') }}",
            columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
