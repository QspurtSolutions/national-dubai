...
<div class="card radius-10 w-100">
    <div class="card-body">
        ...
        <input type="text"  name="heading" id="heading" class="form-control @error('heading') is-invalid @enderror"  value="{{ isset($heading) ? $heading->heading : '' }}" placeholder="heading">
        @error('tittle')
        ...
        @enderror
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-light px-5">{{ $categories->id ? 'Update' : 'Submit' }}</button>
            </div>
        </form>
    </div>
</div>
